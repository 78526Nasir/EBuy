                ...
                <table class="responsive-table">
                    ...
                    <tr>
                        ...
                        <td class="required">
                            ...
                            <asp:RegularExpressionValidator ID="rev3" runat="server" ControlToValidate="txtUsername" ValidationExpression="^(?=.*[a-z])[a-zA-Z\d_-]{3,}"
                    ...
                    <tr>
                        ...
                        <td class="required">
                            ...
                            <asp:RegularExpressionValidator ID="regEV1" runat="server" ControlToValidate="txtFullName"  ValidationExpression="^(?=.*[a-z])[a-z A-Z_-]{3,50}"
